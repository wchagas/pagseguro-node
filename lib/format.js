 ...
 * @return {Object}
 */function shipping(a){if(!validate.isObject(a))return{addressRequired:!1};if(a=clone(a),a.hasOwnProperty("addressRequired")&&!1==a.addressRequired)return{addressRequired:!1};if(0==Object.keys(a).length)return{addressRequired:!1};var b={address:a};return a.type&&(b.type=a.type),a.cost&&(b.cost=a.cost.toFixed?a.cost.toFixed(2):a.cost),b}/**
 * extraAmount
 * @param {Number} extraAmount
 * @return {Object}
 */function extraAmount(a){return a&&a.toFixed&&(a=a.toFixed(2)),a}/**
 * items
 * @param {Array} item
 * @return {Object}
 */function items(a){return validate.isArray(a)?(a=clone(a),{item:a.map(function(a){return a.amount&&a.amount.toFixed&&(a.amount=a.amount.toFixed(2)),a})}):{item:[]}}/**
 * permissions
 ...
 * exports
 */module.exports={sender:sender,creditCard:creditCard,shipping:shipping,billing:billing,items:items,extraAmount:extraAmount,permissions:permissions,account:account};